                ...
                if (!usernameId.getText().toString().equals("") && !passwordId.getText().toString().equals("") && !repeatId.getText().toString().equals("")) {
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            PutData putData = new PutData("http://192.168.2.166/stepitup/signup.php", "POST", field, data); //HIER MOET ZEKER JE EIGEN PRIVE IP ADRES ZITTEN IN PLAATS VAN MIJN (JORDI'S IP)
                            if (putData.startPut()) {
