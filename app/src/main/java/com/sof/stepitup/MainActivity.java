...
//                    progressBar.setVisibility(View.VISIBLE);
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            PutData putData = new PutData("http://145.52.131.204/stepitup/login.php", "POST", field, data); //HIER MOET ZEKER JE EIGEN PRIVE IP ADRES ZITTEN IN PLAATS VAN MIJN (JORDI'S IP)
                            if (putData.startPut()) {
